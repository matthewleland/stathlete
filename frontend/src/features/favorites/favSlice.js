...
// create new favorite
export const createFavorite = createAsyncThunk('favorites/create', async (favData, thunkAPI) => {
  try {
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(deleteFavorite.fulfilled, (state, action) => {
        state.isLoading = false
        state.isSuccess = true
        state.favorites = state.favorites.filter((favorite) => favorite._id !== action.payload.id)
      })
